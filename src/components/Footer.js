        ...
        <footer className="w-full border-t-2 border-solid border-dark font-medium text-lg dark:text-light dark:border-light sm:text-sm">
            <Layout className="py-8 flex items-center justify-between lg:flex-col lg:py-6">
                ...
                <div className="flex items-center lg:py-1">
                    ...
                    <Link href="mailto:rahulsrkr29@gmail.com" className="underline underline-offset-2">RahulSrk</Link>
                </div>
                <Link href="mailto:rahulsrkr29@gmail.com" className="underline underline-offset-2" target="_blank">Say hello</Link>
            </Layout>
        </footer>
    )
}
